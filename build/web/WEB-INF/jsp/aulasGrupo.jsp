<%-- 
    Document   : aulasGrupo
    Created on : 19/jun/2021, 18:02:27
...
<html>
    ...
    <body>
        ...
        <div class="barraSuperior">
            ...
            <h2 align="center" style="margin:20px 0; padding-top: 30px">Aulas de grupo</h2>
                ...
                <tbody>
                    ...
                    <c:forEach items="${aulas}" var="aula">
                        <tr style="background:#fff;">
                            <td align="center" style="font-size: 16px ; padding: 8px 0">${aula.nome}</td>
                            <td align="center" style="font-size: 16px ; padding: 8px 0">${aula.diasemana}</td>
                            <td align="center" style="font-size: 16px ; padding: 8px 0">${aula.horarioinicial}</td>
                            <td align="center" style="font-size: 16px ; padding: 8px 0">${aula.horariofinal}</td>
                            <td align="center" style="font-size: 16px ; padding: 8px 0">${aula.idfuncionario.nome}</td>
                            <form  method="post">
                              <td align="center" style="font-size: 16px ; padding: 8px 0"> 
                                   <button id="inscrever" name="inscrever" type="submit" formaction="?id=${aula.idaula}&client=${loggedUser.idcliente}&save">Inscrever</button>
                               </td>
                            </form>
                        </tr>
                    </c:forEach>
